...
const getAiData = (buffers) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const prompt = `fist check is this a math problem image. isn't a math problem send "This is not a math problem". is a math problem solve this math problem.is it solved check the answer for correctness and provide the solution step-by-step with some explains.`;
    const image = {
        inlineData: {
